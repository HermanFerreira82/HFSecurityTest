...
namespace IdentityServer.services
{
    public class InMemUserStore
    {
        ...
        public InMemUserStore(List<TestUser> users)
        {
            _users = users;
        }
        ...
        public TestUser AutoProvisionUser(string provider, string userId, List<Claim> claims)
        {
            ...
            var sub = filtered.FirstOrDefault(x=>x.Type == JwtClaimTypes.Subject)?.Value ?? CryptoRandom.CreateUniqueId(format: CryptoRandom.OutputFormat.Hex);
